...
type Props = {
  ...
  onExportMonthly: (workloadId: string) => void;
};

export function WorkloadList({ selectedId, selectedMonth, logs, onSelect, onExportMonthly }: Props) {
  return (
