...
3. ไปที่ **Authentication > Users > Add user** สร้างอีเมลและรหัสผ่านสำหรับผู้ใช้คนเดียว
...
ไม่มีหน้า Sign up ในระบบ ผู้ดูแลสร้างหรือเปลี่ยนผู้ใช้จาก Supabase Dashboard เท่านั้น
